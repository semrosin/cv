...
export const WorkCard = forwardRef(({ work, className = "" }, ref) => {
  return (
    <a
      ...
      className={`group flex flex-col-reverse overflow-hidden rounded-2xl bg-zinc-900 transition-all duration-300 hover:scale-[1.01] hover:shadow-[0_0_18px_var(--color-pink-400)] lg:min-h-105 lg:flex-row ${className}`}
    >
