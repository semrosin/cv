...
function NavBar(props) {
  ...
  return (
    <div className="flex flex-row w-full bg-black" id="Navbar">
      <ul className="flex flex-row justify-start w-full text-white my-4 2xl:my-5 font-sans text-mg sm:text-lg xl:text-2xl">
        {sectionRefs.map((ref) => (
