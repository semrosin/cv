...
const ConversationPage = () => {
  ...
  return (
    <div className="flex flex-col items-center h-screen max-h-screen w-screen bg-white">
        <div className="w-full flex fixed text-pink-400 pt-4 md:pt-7 items-center bg-black">
